...
date: 2025-01-01
cover: ../../assets/projects/avatar_sismico.jpg
tags: [unreal]
featured: true
year: 2025
...
A second collaboration with CIGIDEN, this project pushed the boundary between scientific communication and interactive installation. The result was a real-time conversational AI avatar — built with ConvAI's character platform and deployed in Unreal Engine — trained to discuss seismic events in general and specifically in Chile.

The avatar was embedded in a live projection mapping installation projected over a physical terrain model of Valparaíso's topography. As visitors approached and spoke to it, a seismic simulation ran across the mapped surface in real time, making the conversation spatially and geographically immediate.
